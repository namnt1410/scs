...
int max_loop_count;
int max_nonimproved_continous_loop_count;

#ifdef LS_CONF_MAX_LOOP_COUNT
#define LS_MAX_LOOP_COUNT LS_CONF_MAX_LOOP_COUNT
#else
#define LS_MAX_LOOP_COUNT max_loop_count
#endif

#ifdef LS_CONF_MAX_NONIMPROVED_CONTINUOUS_LOOP_COUNT
#define LS_CONF_MAX_NONIMPROVED_CONTINUOUS_LOOP_COUNT LS_CONF_MAX_NONIMPROVED_CONTINUOUS_LOOP_COUNT
#else
#define LS_MAX_NONIMPROVED_CONTINUOUS_LOOP_COUNT max_nonimproved_continous_loop_count
#endif
